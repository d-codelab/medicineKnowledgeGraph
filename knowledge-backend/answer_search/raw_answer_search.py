...
class RawAnswerSearcher(object):
    ...
    def __init__(self):
        ...
        # self.graph = Graph(f"http://{SysConfig.NEO4J_HOST}:{SysConfig.NEO4J_PORT}",
        #                    auth=(SysConfig.NEO4J_USER, SysConfig.NEO4J_PASSWORD))
        # self.graph = Graph(f"{SysConfig.NEO4J_HOST}:{SysConfig.NEO4J_PORT}",
        #                    auth=(SysConfig.NEO4J_USER, SysConfig.NEO4J_PASSWORD))
        self.graph = Graph(f"{SysConfig.NEO4J_HOST}:{SysConfig.NEO4J_PORT}",
                           auth=(SysConfig.NEO4J_USER, SysConfig.NEO4J_PASSWORD), name="neo4j")
