...
class RuleQuestionClassifier(object):
    ...
    def _init(self):
        # load data
        # self.word_kind_dict = None
        # self.word_kind_dict = self._build_word_kind_dict()
        ...
        for index, file_path in enumerate(file_list):
            ...
            # 假设项目的根目录位于当前目录的上一级，可以进一步构建项目的根路径

            file_relative_path = os.path.join("data", "dict", "disease.txt")
            file_absolute_path = os.path.join(parent_dir, file_relative_path)
            data_list = self._load_line_file(file_absolute_path)
        ...
        # self.word_kind_dict = None
        # # 初始化你的特征词列表
        # self.region_feature_words = []
        # self.disease_feature_words = []
        # self.department_feature_words = []
        # self.check_feature_words = []
        # self.drug_feature_words = []
        # self.food_feature_words = []
        # self.symptom_feature_words = []
        # self.producer_feature_words = []
    ...
    def _build_word_kind_dict(self):
        if self.word_kind_dict is not None:
            return self.word_kind_dict
