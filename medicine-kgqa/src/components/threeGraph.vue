  ...
  methods: {
    ...
    update () {
      if (this.graph.length <= 20) {
        this.graph = require('../data/top5test.json')
      } else {
        // this.graph = require('../data/records.json')
        this.graph = require('../data/recordsTest.json')
      }
    ...
    threeRender () {
      ...
      this.Graph.height(520).width(1200)
        ...
        .onNodeClick(node => {
          ...
          // switch(node.label) {
          //   case 'Disease': break;
          //   case 'Department': index = 1;break;
          //   case 'Symptom': index = 2;break;
          //   default: index = 3;break;
          // }
          let i = 0
          for (;i < this.labels.length;i++) {
        ...
        //   const colors = ['#faa']
        //   switch(link.type) {
        //     case 'recommand_eat': break;
        //     case 'department_is': index = 1;break;
        //     case 'has_symptom': index = 2;break;
        //     default: index = 3;break;
        //   }
        //   return this.nodeColors[index]
        // })
